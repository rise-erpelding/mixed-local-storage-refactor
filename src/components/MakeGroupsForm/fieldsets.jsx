...
export const GroupingCharacteristicsField = ({
  ...
  return (
    ...
    >
      ...
      />
      <RadioInputSection
        checkedStatuses={[groupingType === 'similar', groupingType === 'mixed']}
...
export const AliasesField = ({
  ...
  return (
    <FieldsetContainer className={className} legendText={fieldName}>
      <div className="make-groups-page__form--before-textarea">
        ...
        <ValidationError
          message={aliasGroupSizeValidationFunc(aliases, groupSize)}
        />
      </div>
    ...
    <FieldsetContainer className={className} legendText={fieldName}>
      <div className="make-groups-page__form--before-textarea">
        <RadioInputSection
          ...
          inputIds={[
            `cat${categoryNumber}-quantitative`,
            `cat${categoryNumber}-qualitative`,
          ]}
          onChangeFunc={(event) => {
            arrUpdateFunc(
              event,
...
AliasesField.propTypes = {
  ...
  groupSize: propTypes.oneOfType([propTypes.string, propTypes.number]), // TODO: fix eventually, updateGroupSize coerces inputted str into num so it can be either
