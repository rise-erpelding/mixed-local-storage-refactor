...
export const RadioInputSection = ({ checkedStatuses, explanation, labels, inputGroupName, inputIds, onChangeFunc, required, values }) => {
  return (
    <section>
      ...
      {values.map((value, index) => (
        <div
          key={value}
          className="make-groups-page__form--radio-buttons">
            <input
